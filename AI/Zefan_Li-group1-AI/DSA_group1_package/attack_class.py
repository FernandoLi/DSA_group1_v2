...
class Attack(State):
    ...
    # def win_check(self, stat, storage):
    ...
    #         if delta == 0:
    #             self.store['win_check'] = MIDDLE
    #         elif delta == 1 or delta == -3:
    #             self.store['win_check'] = RIGHT
    #         elif delta == -1 or delta == 3:
    #             self.store['win_check'] = LEFT  # 计算下一步应该怎么走
    #         else:
    #             return False
    ...
    #                     if self.field_compare(me['id'], stat['now']['enemy']['id'], stat, storage):
    #                         return True
    #                     else:
    #                         return False
    #                 else:
